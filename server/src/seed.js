...
await Settings.create({
  siteName_ar:'الأكاديمية العليا للرموز والشيفرة', siteName_en:'The Higher Academy of Symbols and Code',
  tagline_ar:'حيث تتحول العلامات إلى معرفة', tagline_en:'Where symbols become structured knowledge',
  heroTitle_ar:'الأكاديمية العليا للرموز والشيفرة', heroTitle_en:'The Higher Academy of Symbols and Code',
  ...
  aboutText_ar:'الأكاديمية العليا للرموز والشيفرة مؤسسة تعليمية ذكية تُعنى بالبحث العلمي والتعليم المبتكر.', aboutText_en:'The Higher Academy of Symbols and Code is a smart educational institution focused on rigorous scientific research.',
  ...
  founderTitle_ar:'مؤسِّسة الأكاديمية العليا للرموز والشيفرة', founderTitle_en:'Founder of The Higher Academy of Symbols and Code',
