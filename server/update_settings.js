...
async function updateDB() {
  ...
  const result = await Settings.updateMany({}, {
    $set: {
      siteName_ar: 'الأكاديمية العليا للرموز والشيفرة',
      siteName_en: 'The Higher Academy of Symbols and Code',
      heroTitle_ar: 'الأكاديمية العليا للرموز والشيفرة',
      ...
      aboutText_ar: 'الأكاديمية العليا للرموز والشيفرة مؤسسة تعليمية ذكية تُعنى بالبحث العلمي والتعليم المبتكر.',
      ...
      founderTitle_ar: 'مؤسِّسة الأكاديمية العليا للرموز والشيفرة',
