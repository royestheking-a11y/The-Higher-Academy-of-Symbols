      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <motion.div initial={{ opacity: 0, x: isRTL ? 20 : -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-5">
            ...
            <a 
              href="https://wa.me/971567199176" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-3 p-4 rounded-2xl text-sm font-bold transition-all hover:-translate-y-1"
              style={{ background: `linear-gradient(135deg, ${BRAND.deep}, ${BRAND.mid})`, border: '1px solid rgba(201,162,74,0.25)', color: BRAND.goldLight, boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}
            >
