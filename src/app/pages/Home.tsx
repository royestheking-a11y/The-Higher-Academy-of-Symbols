        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <img
                src={logoImg}
                alt="The Higher Academy of Symbol and Cipher — Phoenix Emblem"
          ...
          >
            ...
            <div className="p-5 rounded-2xl mb-6 relative" style={{ background: 'rgba(6,43,36,0.05)', border: '1px solid rgba(6,43,36,0.1)' }}>
              ...
              <p className="text-[#3A5A50] text-base leading-relaxed italic" style={{ fontFamily: isRTL ? 'Amiri, serif' : 'Cormorant Garamond, serif' }}>
                {t(
                  'الأكاديمية العليا للرمز والشيفرة — حيث تتحول العلامات إلى معرفة منهجية راسخة.',
                  'The Higher Academy of Symbol and Cipher — where signs become structured, enduring knowledge.'
                )}
              </p>
            </div>
