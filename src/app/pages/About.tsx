...
export default function About() {
  ...
  const timeline = [
    { year: '2023', title_ar: 'فكرة التأسيس', title_en: 'Founding Idea', desc_ar: 'ولدت فكرة الأكاديمية العليا للرموز والشفرات من رحم البحث العلمي في الدراسات الرمزية.', desc_en: 'The idea of The Higher Academy of Symbols and Codes was born from scientific research in symbolic studies.' },
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center`}>
              ...
              <div className="relative rounded-3xl overflow-hidden aspect-square max-w-md" style={{ background: `linear-gradient(135deg, ${BRAND.deep}, ${BRAND.mid})` }}>
                ...
                <div className="absolute inset-x-0 top-0 flex items-center justify-center p-8" style={{ height: '62%' }}>
                  <img
                    ...
                    alt="The Higher Academy of Symbols and Codes"
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              ...
              <p className="text-[#3A5A50] text-sm leading-relaxed mb-6">
                {t('تأسست الأكاديمية العليا للرموز والشفرات برؤية واضحة: أن تكون المرجع الأول في العالم العربي لدراسة الرمز والسيميائيات والتفير، مع الحفاظ على المنهج العلمي المحايد والرصين.', 'The Higher Academy of Symbols and Codes was founded with a clear vision: to be the primary reference in the Arab world for the study of symbolism, semiotics, and cryptography, while maintaining a neutral and rigorous scientific approach.')}
              </p>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-10 items-center`}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              ...
              <p className="text-[#3A5A50] text-sm leading-relaxed italic" style={{ fontFamily: isRTL ? 'Amiri, serif' : 'Cormorant Garamond, serif' }}>
                {t('"الأكاديمية العليا للرموز والشفرات ليست مجرد مؤسسة تعليمية، بل هي مشروع حضاري يهدف إلى إعادة الاعتبار للتراث العلمي العربي في مجال الرمزية والتشفير."', '"The Higher Academy of Symbols and Codes is not just an educational institution, but a civilizational project aimed at restoring recognition of the Arab scientific heritage in the field of symbolism and cryptography."')}
              </p>
            </motion.div>
          </div>
        </div>
