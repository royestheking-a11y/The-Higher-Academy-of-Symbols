...
export default function About() {
  ...
  const timeline = [
    { year: '2023', title_ar: 'فكرة التأسيس', title_en: 'Founding Idea', desc_ar: 'ولدت فكرة الأكاديمية العليا للرموز والشيفرة من رحم البحث العلمي في الدراسات الرمزية.', desc_en: 'The idea of The Higher Academy of Symbols and Code was born from scientific research in symbolic studies.' },
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center`}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              ...
              <p className="text-[#3A5A50] text-sm leading-relaxed mb-6">
                {t('تأسست الأكاديمية العليا للرموز والشيفرة برؤية واضحة: أن تكون المرجع الأول في العالم العربي لدراسة الرمز والسيميائيات والتفير، مع الحفاظ على المنهج العلمي المحايد والرصين.', 'The Higher Academy of Symbols and Code was founded with a clear vision: to be the primary reference in the Arab world for the study of symbolism, semiotics, and cryptography, while maintaining a neutral and rigorous scientific approach.')}
              </p>
