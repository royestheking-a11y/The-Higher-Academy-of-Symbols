            ...
            <div className="flex-1 overflow-auto p-8 flex flex-col items-center bg-[#F8F6F0]">
              ...
              >
                ...
                <div className="mt-0 mb-2">
                  ...
                  {isRTL ? (
                    <>
                      <div className="text-[#062B24] text-lg font-bold">الأكاديمية العليا للرموز والشفرة</div>
                    ...
                    <>
                      ...
                      <div className="text-[#C9A24A] text-[10px] font-bold mt-1">الأكاديمية العليا للرموز والشفرة</div>
                    </>
                  )}
                </div>
